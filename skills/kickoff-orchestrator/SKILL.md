...
- how의 **M0a 완료 조건이 환경 검증(`godot --headless --import` + smoke)** + **M0b 완료 조건이 코어 버브 1회 수행** 둘 다 포함
...
- 마일스톤별 walkthrough: M0a → M0b → F1 → ... → FN
...
- PRD의 마일스톤 표 행 수 = `_feature-list.md` 행 수 (M0a/M0b 포함)
