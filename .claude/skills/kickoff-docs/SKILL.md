...
3. **1플레이어 원형·1코어 결핍·1코어 버브 원칙 위반 금지.** Niche Enforcer(`niche-enforcement` 스킬의 게임 테이블 참조)의 승인 없이 확장 금지.
...
## Godot MCP 의존
- capability matrix: `.claude/skills/godot-mcp-protocol/references/capability-matrix.md`
...
| M | 기간 | 산출물 | 완료 조건 |
|---|-----|-------|----------|
| **M0** | 1~2주 | Walking Skeleton | 플레이어가 3D 공간에서 **코어 버브 1회** 수행 가능 (primitive 에셋, smoke 씬 headless 통과) |
...
7. Reviewer 팀(architect/implementer/qa)에게 how.md 전달
...
- how의 M0 완료 조건에 **"코어 버브 1회 수행 가능"** 필수 포함
